...
echo "     ./pc_build_calendar.py --all              # timestamped packages, default 10 events each"
...
echo "   testing zone (isolated sandbox in records_test/, real archive untouched; monitor MODE=TEST):"
