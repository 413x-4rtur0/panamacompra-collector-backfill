...
say "  ./src/webhook/020-start-listener.sh           # only for all-host / host.docker.internal mode"
say "  ./src/webhook/040-diagnose-webhook.sh"
say "  ./src/pipeline/130a-queue-status.sh"
say ""
