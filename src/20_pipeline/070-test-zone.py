...
write_packages = load_script("src/20_pipeline/060-build-calendar.py").write_packages
...
def run_test_zone(rows):
    ...
    process_detail = load_script("src/20_pipeline/030-collect-details.py").process_detail
