...
views for new records; this tool is for archives already on disk.
    ...
    ./src/20_pipeline/040-build-detail-views.py                 # dry-run: preview what would change
    ./src/20_pipeline/040-build-detail-views.py --apply         # write the views into detail.json
    ./src/20_pipeline/040-build-detail-views.py --records-dir /path --apply
"""
import argparse
import json
import re
