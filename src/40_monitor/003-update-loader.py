#!/usr/bin/env python3
"""Tk loader window that runs update-local-copy.sh first, then opens the monitor.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run update-local-copy.sh in a separate loader window")
