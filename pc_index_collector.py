...
def main():
        ...
        for group in GROUPS:
            ...
            for page_number in range(1, MAX_PAGES_PER_GROUP + 1):
                ...
                write_run_progress(
                    ...
                    "RUNNING",
                    percent,
                    f"Step 1/5: {group_name} page {page_number} collected {len(rows)} rows.",
                    step_current=1,
                    step_total=5,
                ...
                write_run_progress(
                    ...
                    "RUNNING",
                    percent,
                    f"Step 1/5: {group_name} page {page_number} processed. New={new_records}, existing={existing_records}.",
                    step_current=1,
                    step_total=5,
                    item_current=overall_page,
                    item_total=total_pages_budget,
    ...
    write_run_progress(
        ...
        "DONE",
        50,
        f"Step 1/5 complete. Unique={len(seen)}, new={new_records}, existing={existing_records}, pending details={pending_details}.",
        step_current=1,
        step_total=5,
